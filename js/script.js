    ...
    if(possibleKeystrokes.includes(key)){
      ...
      if(game && !game.prizeInHand){
        switch(key){
          case "ArrowLeft":
          game.player.left += -50;
          game.player.imgSrc ="./images/characterLeft.png";
          break;
          
          case "ArrowUp":
          game.player.top += -50;
          game.player.imgSrc ="./images/characterBack.png"
          break;

          case "ArrowRight":
          game.player.left += 50;
          game.player.imgSrc ="./images/characterRight.png"
          break;

          case "ArrowDown":
          game.player.top += 50;
          game.player.imgSrc ="./images/character.png"
          break;
      ...
      if(game && game.prizeInHand){
        switch(key){
          case "ArrowLeft":
          game.player.left += -50;
          game.player.imgSrc ="./images/characterLeftPastel.png";

          break;
          
          case "ArrowUp":
          game.player.top += -50;
          game.player.imgSrc ="./images/characterBackPastel.png"

          break;

          case "ArrowRight":
          game.player.left += 50;
          game.player.imgSrc ="./images/characterRightPastel.png"

          break;

          case "ArrowDown":
          game.player.top += 50;
          game.player.imgSrc ="./images/characterPastel.png"
